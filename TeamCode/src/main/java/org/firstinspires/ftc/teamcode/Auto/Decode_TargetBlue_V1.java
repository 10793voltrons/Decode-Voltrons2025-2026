...
@Autonomous(name = "Decode_TargetBlue_V1")
public class Decode_TargetBlue_V1 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-50, -40, Math.toRadians(135));
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose) //movimiento al sumergible
                .lineToLinearHeading(new Pose2d(-5,-50,Math.toRadians(-30)))
                .build();
